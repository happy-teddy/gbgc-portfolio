    ...
    <>
      <Container className="mt-9">
        <div className="max-w-full">
          ...
          <h2 className="mt-16 text-xl font-semibold tracking-tight text-zinc-800 sm:text-3xl dark:text-zinc-100">
          ...
          <div className="mt-6 flex gap-6">
            <a href="https://twitter.com/gbgccoin">
              <FontAwesomeIcon
                icon={faXTwitter}
                size="1x"
            ...
            <a href="https://www.instagram.com/gbgccoin/">
              <FontAwesomeIcon
                icon={faInstagram}
                size="1x"
                className="h-[20px] w-[20px]"
            ...
            <a href="https://www.facebook.com/profile.php?id=100087517007504">
              <FontAwesomeIcon
                icon={faFacebookF}
                size="1x"
                className="h-[20px] w-[20px]"
